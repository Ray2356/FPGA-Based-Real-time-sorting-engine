...
HD_PWD='C:/Users/yyuanaw/seven_seg_test/seven_seg_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_seven_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_seven_seg.tcl -notrace
