...
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { data_comb[0] }]; # IO_L16N_T2_34 Sch=ld0
set_property -dict { PACKAGE_PIN E19   IOSTANDARD LVCMOS33 } [get_ports { data_comb[1] }]; # IO_L6N_T0_34 Sch=ld1
set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { data_comb[2] }]; # IO_L13N_T2_MRCC_34 Sch=ld2
set_property -dict { PACKAGE_PIN V19   IOSTANDARD LVCMOS33 } [get_ports { data_comb[3] }]; # IO_L12N_T1_MRCC_34 Sch=ld3
set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { data_comb[4] }]; # IO_L7N_T1_34 Sch=ld4
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports { data_comb[5] }]; # IO_L17N_T2_34 Sch=ld5
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { data_comb[6] }]; # IO_L5N_T0_DQS_AD1N_34 Sch=ld6
set_property -dict { PACKAGE_PIN V14    IOSTANDARD LVCMOS33 } [get_ports { data_comb[7] }];

set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { tx_start }];
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { busy }];
